...
public final class AlchemyMixtureManualOverlay {
    private static final String PAGE_KEY = "book.totem.alchemy_manual.page.15";
    ...
    private static void render(TotemManualPageRenderContext context) {
        ...
        centered(context, "book.totem.alchemy_manual.mixture.mix", y + 20, GOOD);
        ...
        centered(context, "book.totem.alchemy_manual.mixture.bottle_early", y + 20, WARN);
        ...
        centered(context, "book.totem.alchemy_manual.mixture.resume", y + 20, GOOD);
        ...
        centered(context, "book.totem.alchemy_manual.mixture.counteract", y + 20, MUTED);
    }
